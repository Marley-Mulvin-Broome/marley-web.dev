...
<div class="w-full grid grid-cols-6 items-center mb-2">
	<ArticleColumnHeader class="col-span-3">
		{$t('common.articles.name')}
	</ArticleColumnHeader>

	<ArticleColumnHeader class="col-span-2">
		{$t('common.articles.category')}
	</ArticleColumnHeader>

	<ArticleColumnHeader class="col-span-1">
