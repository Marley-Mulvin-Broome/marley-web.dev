<script lang="ts">
  ...
  let { title, category, date, slug }: Props = $props();
</script>

<a class="grid grid-cols-6 items-center w-full hover:bg-gray-600/20 rounded-md" href='/folders/articles/{slug}'>
  <div class="col-span-3 flex flex-row items-center gap-2">
    <svg class="text-accent w-8 max-h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
