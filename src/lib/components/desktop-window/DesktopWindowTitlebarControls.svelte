...
<div
  class="flex flex-row gap-2 justify-center items-center bg-transparent px-4 py-3"
>
  {#snippet circle(variant, href)}
    <a {href} aria-label="{variant} Window" class="rounded-full" onclick={(e) => { handleClick(e, variant) }}>
