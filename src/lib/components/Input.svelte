...
>
  <input
    ...
    onfocusout={handleFocus} oninput={handleInput} bind:value data-valid={isValid} data-show-validator={showInvalidator}
    {...props}
  />

  {#if showInvalidator}
    <p
      class="text-red-400 text-sm font-light mt-[2px]"
    >
