...
{#if open}
	...
	>
		<div class="flex flex-col gap-4 w-1/2" onclick={stopPropagation()}>
			<div class="bg-primary-light rounded-md p-4 flex flex-row items-center gap-4 w-full">
				<input
					class="p-2 bg-transparent border-b-2 border-b-accent/50 focus:outline-none focus:border-b-accent transition-colors flex-1 peer"
					type="text"
